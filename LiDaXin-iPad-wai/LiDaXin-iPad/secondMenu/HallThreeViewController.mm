...
@interface HallThreeViewController ()

@end

@implementation HallThreeViewController
...
-(void) viewWillAppear:(BOOL)animated
{
    ...
    if (self.m_bFreshImageBlock) {
        ...
        for (int i=0; i<10; i++) {
            NSString* str = [NSString stringWithFormat:@"C%d",i+1];
...
- (IBAction)roomButton:(id)sender {
    ...
    switch (button.tag) {
        ...
        {
            roomobj.m_roomId = @"C5";
            roomobj.m_roomName = @"Showcase";
        }
            break;
        case 5:
        {
            roomobj.m_roomId = @"C6";
            roomobj.m_roomName = @"Corridor";
        }
            break;
        case 6:
        {
            roomobj.m_roomId = @"C7";
            roomobj.m_roomName = @"Hall";
        }
            break;
        case 7:
        {
        ...
        {
            roomobj.m_roomId = @"C9";
            roomobj.m_roomName = @"Commercial Area";
        }
            break;
        case 9:
        {
            roomobj.m_roomId = @"C10";
            roomobj.m_roomName = @"Showcase";
        }
            break;
        default:
