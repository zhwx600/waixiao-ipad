...
@synthesize m_blockImage11;
@synthesize m_blockImage12;
        ...
        for (int i=0; i<12; i++) {
            ...
            if (arr && arr.count>0) {
                switch (i) {
                    ...
                    case 10:
                    {
                        [self.m_blockImage11 setHidden:YES];
                    }
                        break;
                    case 11:
                    {
                        [self.m_blockImage12 setHidden:YES];
                    }
                        break;
                    default:
                        break;
                ...
                switch (i) {
                    case 0:
                    {
                        [self.m_blockImage1 setHidden:NO];
                    }
                        break;
                    case 1:
                    {
                        [self.m_blockImage2 setHidden:NO];
                    }
                        break;
                    case 2:
                    {
                        [self.m_blockImage3 setHidden:NO];
                    }
                        break;
                    case 3:
                    {
                        [self.m_blockImage4 setHidden:NO];
                    }
                        break;
                    case 4:
                    {
                        [self.m_blockImage5 setHidden:NO];
                    }
                        break;
                    case 5:
                    {
                        [self.m_blockImage6 setHidden:NO];
                    }
                        break;
                    case 6:
                    {
                        [self.m_blockImage7 setHidden:NO];
                    }
                        break;
                    case 7:
                    {
                        [self.m_blockImage8 setHidden:NO];
                    }
                        break;
                    case 8:
                    {
                        [self.m_blockImage9 setHidden:NO];
                    }
                        break;
                    case 9:
                    {
                        [self.m_blockImage10 setHidden:NO];
                    }
                        break;
                    case 10:
                    {
                        [self.m_blockImage11 setHidden:NO];
                    }
                        break;
                    case 11:
                    {
                        [self.m_blockImage12 setHidden:NO];
                    }
                        break;
                    default:
                        break;
...
- (void)viewDidUnload
{
    ...
    [self setM_blockImage11:nil];
    [self setM_blockImage12:nil];
    [super viewDidUnload];
...
- (IBAction)twoRoomButton:(id)sender {
    ...
    switch (button.tag) {
        ...
        {
            roomobj.m_roomId = @"B2";
            roomobj.m_roomName = @"Product Area";
        }
            break;
        case 2:
        {
        ...
        {
            roomobj.m_roomId = @"B6";
            roomobj.m_roomName = @"Promotion Area";
        }
            break;
        case 6:
        {
        ...
        case 10:
        {
            roomobj.m_roomId = @"B11";
            roomobj.m_roomName = @"Product Area";
        }
            break;
        case 11:
        {
            roomobj.m_roomId = @"B12";
            roomobj.m_roomName = @"Promotion Area";
        }
            break;
...
- (void)dealloc {
    ...
    [m_blockImage11 release];
    [m_blockImage12 release];
    [super dealloc];
}
@end
