...
@interface HallTwoViewController : UIViewController<AZGenieAnimationDelegate>
...
@property (retain, nonatomic) IBOutlet UIView *m_blockImage11;
@property (retain, nonatomic) IBOutlet UIView *m_blockImage12;
