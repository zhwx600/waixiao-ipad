...
/**
	...
	Generally Accept() is called on the TTiXmlDocument, although all nodes suppert Visiting.

	You should never change the document from a callback.

	@sa TTiXmlNode::Accept()
*/
class TiXmlVisitor
{
public:
	...
	/// Visit a document.
	virtual bool VisitEnter( const TTiXmlDocument& /*doc*/ )			{ return true; }
	/// Visit a document.
	virtual bool VisitExit( const TTiXmlDocument& /*doc*/ )			{ return true; }

	/// Visit an element.
	virtual bool VisitEnter( const TTiXmlElement& /*element*/, const TTiXmlAttribute* /*firstAttribute*/ )	{ return true; }
	/// Visit an element.
	virtual bool VisitExit( const TTiXmlElement& /*element*/ )		{ return true; }

	/// Visit a declaration
	virtual bool Visit( const TTiXmlDeclaration& /*declaration*/ )	{ return true; }
	/// Visit a text node
	virtual bool Visit( const TTiXmlText& /*text*/ )					{ return true; }
	/// Visit a comment node
	virtual bool Visit( const TTiXmlComment& /*comment*/ )			{ return true; }
	/// Visit an unknow node
	virtual bool Visit( const TTiXmlUnknown& /*unknown*/ )			{ return true; }
};
...
const TTiXmlEncoding TIXML_DEFAULT_ENCODING = TIXML_ENCODING_UNKNOWN;
...
public:
	...
	*/
	...
	virtual const char* Parse(	const char* p, 
								...
								TTiXmlEncoding encoding /*= TIXML_ENCODING_UNKNOWN */ ) = 0;
...
protected:
	...
	*/
	static const char* ReadName( const char* p, TIXML_STRING* name, TTiXmlEncoding encoding );
...
public:
	...
	*/
	...
	TTiXmlNode* FirstChild( const char * _value ) {
		// Call through to the const version - safe since nothing is changed. Exiting syntax: cast this to a const (always safe)
		// call the method, cast the return back to non-const.
		return const_cast< TTiXmlNode* > ((const_cast< const TTiXmlNode* >(this))->FirstChild( _value ));
	}
	...
	TTiXmlNode* LastChild( const char * _value ) {
		return const_cast< TTiXmlNode* > ((const_cast< const TTiXmlNode* >(this))->LastChild( _value ));
	}
	...
	*/
	...
	TTiXmlNode* IterateChildren( const TTiXmlNode* previous ) {
		return const_cast< TTiXmlNode* >( (const_cast< const TTiXmlNode* >(this))->IterateChildren( previous ) );
	}

	/// This flavor of IterateChildren searches for children with a particular 'value'
	const TTiXmlNode* IterateChildren( const char * value, const TTiXmlNode* previous ) const;
	TTiXmlNode* IterateChildren( const char * _value, const TTiXmlNode* previous ) {
		return const_cast< TTiXmlNode* >( (const_cast< const TTiXmlNode* >(this))->IterateChildren( _value, previous ) );
	}
	...
	TTiXmlNode* IterateChildren( const std::string& _value, const TTiXmlNode* previous ) {	return IterateChildren (_value.c_str (), previous);	}	///< STL std::string form.
	#endif
	...
	*/
	...
	TTiXmlNode* PreviousSibling( const char *_prev ) {
		return const_cast< TTiXmlNode* >( (const_cast< const TTiXmlNode* >(this))->PreviousSibling( _prev ) );
	}
	...
	TTiXmlNode* NextSibling( const char* _next ) {
		return const_cast< TTiXmlNode* >( (const_cast< const TTiXmlNode* >(this))->NextSibling( _next ) );
	}
	...
	*/
	...
	TTiXmlElement* NextSiblingElement() {
		return const_cast< TTiXmlElement* >( (const_cast< const TTiXmlNode* >(this))->NextSiblingElement() );
	}
	...
	*/
	...
	TTiXmlElement* NextSiblingElement( const char *_next ) {
		return const_cast< TTiXmlElement* >( (const_cast< const TTiXmlNode* >(this))->NextSiblingElement( _next ) );
	}
	...
	TTiXmlElement* FirstChildElement() {
		return const_cast< TTiXmlElement* >( (const_cast< const TTiXmlNode* >(this))->FirstChildElement() );
	}

	/// Convenience function to get through elements.
	const TTiXmlElement* FirstChildElement( const char * _value ) const;
	TTiXmlElement* FirstChildElement( const char * _value ) {
		return const_cast< TTiXmlElement* >( (const_cast< const TTiXmlNode* >(this))->FirstChildElement( _value ) );
	}
	...
	*/
	...
	TTiXmlDocument* GetDocument() {
		return const_cast< TTiXmlDocument* >( (const_cast< const TTiXmlNode* >(this))->GetDocument() );
	}
...
public:
	...
	*/
	...
	TTiXmlAttribute* Next() {
		return const_cast< TTiXmlAttribute* >( (const_cast< const TTiXmlAttribute* >(this))->Next() ); 
	}

	/// Get the previous sibling attribute in the DOM. Returns null at beginning.
	const TTiXmlAttribute* Previous() const;
	TTiXmlAttribute* Previous() {
		return const_cast< TTiXmlAttribute* >( (const_cast< const TTiXmlAttribute* >(this))->Previous() ); 
	}
...
public:
	...
	TTiXmlAttribute*	Find( const char* _name ) const;
	TTiXmlAttribute* FindOrCreate( const char* _name );

#	ifdef TIXML_USE_STL
	TTiXmlAttribute*	Find( const std::string& _name ) const;
	TTiXmlAttribute* FindOrCreate( const std::string& _name );
#	endif
...
public:
	...
	TTiXmlComment() : TTiXmlNode( TTiXmlNode::TINYXML_COMMENT ) {}
	/// Construct a comment from text.
	TTiXmlComment( const char* _value ) : TTiXmlNode( TTiXmlNode::TINYXML_COMMENT ) {
		SetValue( _value );
	}
...
public:
	...
	*/
	TTiXmlText (const char * initValue ) : TTiXmlNode (TTiXmlNode::TINYXML_TEXT)
	{
		SetValue( initValue );
		cdata = false;
	}
	...
	#ifdef TIXML_USE_STL
	/// Constructor.
	TTiXmlText( const std::string& initValue ) : TTiXmlNode (TTiXmlNode::TINYXML_TEXT)
	{
		SetValue( initValue );
		cdata = false;
	}
	...
	TTiXmlText( const TTiXmlText& copy ) : TTiXmlNode( TTiXmlNode::TINYXML_TEXT )	{ copy.CopyTo( this ); }
...
public:
	...
	TTiXmlDeclaration()   : TTiXmlNode( TTiXmlNode::TINYXML_DECLARATION ) {}
...
{
public:
	TTiXmlUnknown() : TTiXmlNode( TTiXmlNode::TINYXML_UNKNOWN )	{}
	virtual ~TTiXmlUnknown() {}

	TTiXmlUnknown( const TTiXmlUnknown& copy ) : TTiXmlNode( TTiXmlNode::TINYXML_UNKNOWN )		{ copy.CopyTo( this ); }
...
public:
	...
	*/
	bool LoadFile( TTiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	/// Save a file using the current document value. Returns true if successful.
	bool SaveFile() const;
	/// Load a file using the given filename. Returns true if successful.
	bool LoadFile( const char * filename, TTiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	...
	*/
	bool LoadFile( FILE*, TTiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	/// Save a file using the given FILE*. Returns true if successful.
	bool SaveFile( FILE* ) const;

	#ifdef TIXML_USE_STL
	bool LoadFile( const std::string& filename, TTiXmlEncoding encoding = TIXML_DEFAULT_ENCODING )			///< STL std::string version.
	{
	...
	*/
	virtual const char* Parse( const char* p, TTiXmlParsingData* data = 0, TTiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
...
/**
	...
	TTiXmlElement* child2 = docHandle.FirstChild( "Document" ).FirstChild( "Element" ).Child( "Child", 1 ).ToElement();
	if ( child2 )
	{
		// do something useful
	@endverbatim
	...
	while ( true )
	{
		TTiXmlElement* child = docHandle.FirstChild( "Document" ).FirstChild( "Element" ).Child( "Child", i ).ToElement();
		if ( !child )
			break;
		// do something
		++i;
	...
	@verbatim
	TTiXmlElement* child = docHandle.FirstChild( "Document" ).FirstChild( "Element" ).FirstChild( "Child" ).ToElement();
...
public:
	...
	*/
	TTiXmlNode* ToNode() const			{ return node; } 
	/** Return the handle as a TTiXmlElement. This may return null.
	*/
	TTiXmlElement* ToElement() const		{ return ( ( node && node->ToElement() ) ? node->ToElement() : 0 ); }
	/**	Return the handle as a TTiXmlText. This may return null.
	*/
	TTiXmlText* ToText() const			{ return ( ( node && node->ToText() ) ? node->ToText() : 0 ); }
	/** Return the handle as a TTiXmlUnknown. This may return null.
	*/
	TTiXmlUnknown* ToUnknown() const		{ return ( ( node && node->ToUnknown() ) ? node->ToUnknown() : 0 ); }

	/** @deprecated use ToNode. 
		Return the handle as a TTiXmlNode. This may return null.
	*/
	TTiXmlNode* Node() const			{ return ToNode(); } 
	/** @deprecated use ToElement. 
		Return the handle as a TTiXmlElement. This may return null.
	*/
	TTiXmlElement* Element() const	{ return ToElement(); }
	/**	@deprecated use ToText()
		Return the handle as a TTiXmlText. This may return null.
	*/
	TTiXmlText* Text() const			{ return ToText(); }
	/** @deprecated use ToUnknown()
		Return the handle as a TTiXmlUnknown. This may return null.
	*/
	TTiXmlUnknown* Unknown() const	{ return ToUnknown(); }
...
/** Print to memory functionality. The TiXmlPrinter is useful when you need to:
	...
	of the XML document. After TTiXmlNode::Accept() is called, the printed document can
...
public:
	...
	virtual bool VisitEnter( const TTiXmlDocument& doc );
	virtual bool VisitExit( const TTiXmlDocument& doc );

	virtual bool VisitEnter( const TTiXmlElement& element, const TTiXmlAttribute* firstAttribute );
	virtual bool VisitExit( const TTiXmlElement& element );

	virtual bool Visit( const TTiXmlDeclaration& declaration );
	virtual bool Visit( const TTiXmlText& text );
	virtual bool Visit( const TTiXmlComment& comment );
	virtual bool Visit( const TTiXmlUnknown& unknown );
